...
import { viewCertif } from "../../data/title";
import github from "../../assets/sololearn.png";
import githubActive from "../../assets/sololearn_active.png";
  ...
  return (
    <div className="w-full shadow-lg bg-[#1f2945] p-4 rounded-lg flex flex-col items-center h-[500px]">
      <div className="h-110 overflow-hidden flex flex-col items-center justify-start">
        <img src={img} className="h-4/5 w-full object-contain rounded-t-lg pb-4" />
